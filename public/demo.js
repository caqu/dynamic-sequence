...
parseq.parallel(
  ...
  [
    widget("A"),
    parseq.race([widget("Race B0"), widget("Race B1"), widget("Race B2")]),
    parseq.sequence([widget("Seq C0"), widget("Seq C1"), widget("Seq C2")]),
    parseq.sequence([widget("Seq D0"), widget("Seq D1"), widget("Seq D2")]),
    parseq.fallback([widget("Fall F0"), widget("Fall F1"), widget("Fall F2")])
  ],
  // Optional
  [
    widget("Opt Q"),
